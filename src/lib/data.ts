...
export const tailwindPalette: Record<string, Record<number, string>> = {
  // --- Slate (Cool Neutral) ---
  slate: {
...
export const brandOptions = Object.keys(tailwindPalette).filter(
  (k) => !['slate', 'gray', 'zinc', 'neutral', 'stone'].includes(k)
);